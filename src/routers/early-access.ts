...
import { project, waitlist } from '../db/schema/index.js';
...
export const earlyAccessRouter = createTRPCRouter({
  // Deprecated live-mode archive. Keep admin read access, but do not expose public early-bird writes.
  getWaitlistCount: adminProcedure.query(async ({ ctx }) => {
